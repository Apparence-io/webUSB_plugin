...
class USBInTransferResult {
  ...
  static USBInTransferResult fromDataJS(dynamic dataJS){
    ...
    StatusResponse status = StatusResponseHelper.fromString(getProperty(dataJS, 'status'));
    return USBInTransferResult(data : Uint8List.view(getProperty(data, 'buffer')), status: status);
  }
}
